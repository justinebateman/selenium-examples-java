...
This project contains examples of Selenium tests written in Java. They were written using the [IntelliJ](https://www.jetbrains.com/idea/) IDE. [Maven](https://maven.apache.org/) handles the dependencies and the builds. The test framework used is [TestNG](http://testng.org/doc/)
